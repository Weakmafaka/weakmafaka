(function () {
  ...
  var translations = {
    en: {
      ...
      projects_row_1_type: 'Telegram bot',
      projects_row_1_project: 'Yantarik · Parenting assistant',
      projects_row_1_role: 'Backend & integrations',
      projects_row_2_type: 'Telegram game',
      projects_row_2_project: 'Mafia · Social deduction',
      projects_row_2_role: 'Game logic & backend',
      projects_row_3_type: 'Web interface',
      projects_row_3_project: 'TopVoting · Student Awards',
      projects_row_3_role: 'UI layout & interactions',
    ...
    ru: {
      ...
      projects_row_1_type: 'Telegram-бот',
      projects_row_1_project: 'Янтарик · Помощник родителям',
      projects_row_1_role: 'Backend и интеграции',
      projects_row_2_type: 'Telegram-игра',
      projects_row_2_project: 'Мафия · Игра в Telegram',
      projects_row_2_role: 'Игровая логика и backend',
      projects_row_3_type: 'Веб-интерфейс',
      projects_row_3_project: 'TopVoting · Студенческая премия',
      projects_row_3_role: 'Вёрстка и интерактивность',

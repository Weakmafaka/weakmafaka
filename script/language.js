(function () {
  ...
  var translations = {
    en: {
      ...
      projects_row_2_project: 'Mafia',
      projects_row_2_role: 'Development',
      projects_row_3_type: 'Website',
      projects_row_3_project: 'TopVoting',
      projects_row_3_role: 'Frontend development',
    ...
    ru: {
      ...
      projects_row_3_type: 'Веб-сайт',
      projects_row_3_project: 'TopVoting',
      projects_row_3_role: 'Frontend-разработка',
